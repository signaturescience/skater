...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{peds }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(fid}\OperatorTok{==}\StringTok{"testped1"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{unnest}\NormalTok{(}\DataTypeTok{cols=}\NormalTok{data)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{peds}\OperatorTok{$}\NormalTok{ped[[}\DecValTok{1}\NormalTok{]]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(peds}\OperatorTok{$}\NormalTok{ped[[}\DecValTok{1}\NormalTok{]], }\DataTypeTok{mar=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{4}\NormalTok{), }\DataTypeTok{cex=}\NormalTok{.}\DecValTok{7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot_pedigree}\NormalTok{(peds}\OperatorTok{$}\NormalTok{ped, }\DataTypeTok{file=}\StringTok{"3gens.ped.pdf"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ped2kinpair}\NormalTok{(peds}\OperatorTok{$}\NormalTok{ped[[}\DecValTok{1}\NormalTok{]])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{kinpairs <-}\StringTok{ }
\StringTok{  }\NormalTok{peds }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{pairs=}\NormalTok{purrr}\OperatorTok{::}\KeywordTok{map}\NormalTok{(ped, ped2kinpair)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(fid, pairs) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{unnest}\NormalTok{(}\DataTypeTok{cols=}\NormalTok{pairs)}
\NormalTok{kinpairs}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{kinpairs_subset <-}\StringTok{ }
\StringTok{  }\NormalTok{kinpairs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{group_by}\NormalTok{(k) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{slice}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{)}
\NormalTok{kinpairs_subset}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{kinpairs_subset }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{degree=}\KeywordTok{kin2degree}\NormalTok{(k, }\DataTypeTok{max_degree=}\DecValTok{3}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{randomflip <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x, }\DataTypeTok{p=}\NormalTok{.}\DecValTok{2}\NormalTok{) }\KeywordTok{ifelse}\NormalTok{(}\KeywordTok{runif}\NormalTok{(}\KeywordTok{length}\NormalTok{(x))}\OperatorTok{<}\NormalTok{p, }\KeywordTok{sample}\NormalTok{(}\KeywordTok{unique}\NormalTok{(x)), x)}

\CommentTok{# Infer degree (truth/target) using kin2degree, then randomly flip 20% of them}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{42}\NormalTok{)}
\NormalTok{kinpairs_inferred <-}\StringTok{ }\NormalTok{kinpairs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{degree_truth=}\KeywordTok{kin2degree}\NormalTok{(k, }\DataTypeTok{max_degree=}\DecValTok{3}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{degree_truth=}\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{replace_na}\NormalTok{(degree_truth, }\StringTok{"unrelated"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{degree_inferred=}\KeywordTok{randomflip}\NormalTok{(degree_truth))}
\NormalTok{kinpairs_inferred}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{confusion_matrix}\NormalTok{(}\DataTypeTok{prediction =}\NormalTok{ kinpairs_inferred}\OperatorTok{$}\NormalTok{degree_inferred, }
                 \DataTypeTok{target =}\NormalTok{ kinpairs_inferred}\OperatorTok{$}\NormalTok{degree_truth)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{confusion_matrix}\NormalTok{(}\DataTypeTok{prediction =}\NormalTok{ kinpairs_inferred}\OperatorTok{$}\NormalTok{degree_inferred, }
                 \DataTypeTok{target =}\NormalTok{ kinpairs_inferred}\OperatorTok{$}\NormalTok{degree_truth) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{purrr}\OperatorTok{::}\KeywordTok{pluck}\NormalTok{(}\StringTok{"Table"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{confusion_matrix}\NormalTok{(}\DataTypeTok{prediction =}\NormalTok{ kinpairs_inferred}\OperatorTok{$}\NormalTok{degree_inferred, }
                 \DataTypeTok{target =}\NormalTok{ kinpairs_inferred}\OperatorTok{$}\NormalTok{degree_truth, }
                 \DataTypeTok{longer =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{purrr}\OperatorTok{::}\KeywordTok{pluck}\NormalTok{(}\StringTok{"Other"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{tidyr}\OperatorTok{::}\KeywordTok{spread}\NormalTok{(Class, Value) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{relocate}\NormalTok{(Average, }\DataTypeTok{.after=}\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{last_col}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate_if}\NormalTok{(rlang}\OperatorTok{::}\NormalTok{is_double, signif, }\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
