...
Acevedo\,\textsuperscript{1}, Jianye Ge\,\textsuperscript{2}, August
Woener\,\textsuperscript{2}, Bruce Budowle\,\textsuperscript{2}
}
...
relationship estimation and IBD segment analysis methods produce results
that often require further downstream manipulation and analysis. A
software package with a consistent design and implementation that offers
this downstream analysis functionality is needed.\\
\textbf{Results:} Here we present the skater package for
\textbf{S}NP-based \textbf{k}inship \textbf{a}nalysis, \textbf{t}esting,
and \textbf{e}valuation as an \textbf{R} package. The skater package
contains a suite of well-documented tools for importing, parsing, and
analyzing pedigree data, performing relationship degree inference,
benchmarking relationship degree classification, and summarizing IBD
segment data.\\
