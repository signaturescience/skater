...
The `skater` package provides a collection of utilities for SNP-based kinship analysis. Functions in the package include tools for working with pedigree data, performing relationship degree inference, assessing classification accuracy, and summarizing IBD segment data.
