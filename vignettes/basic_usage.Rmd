...
One of the formats used by PLINK and other genetic analysis tools is the `.fam` file.[^plink-fam] The package includes `read_fam()` to read files in this format:
